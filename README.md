...
- **TSSCI (Temporal Spatial Skeleton Color Image)**:
    - **X-Axis**: Keypoints ordered by kinematic DFS-like sequence (head → arms → torso → legs).
...
- `--max-frames`: Limit processing to a specific number of frames (useful for testing).
